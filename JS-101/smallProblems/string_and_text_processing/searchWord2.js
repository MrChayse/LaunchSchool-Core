/*
**word.toUpperCase()** - highlights the word
if the word exists, replace the word with the highlighted word
return the text with highlighted word.
*/

const searchWord = (word, sent) => {
